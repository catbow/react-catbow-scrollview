...
export default function ScrollView({ option }) {
	...
	useEffect(() => {
		...
		if (observerRef.current) observer.observe(observerRef.current); // eslint-disable-next-line react-hooks/exhaustive-deps
	}, []);
	return /*#__PURE__*/ React.createElement(
		...
		/*#__PURE__*/ React.createElement(
			'div',
			{ style: { position: 'sticky', height: '100%', top: '0px' } },
