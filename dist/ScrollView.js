 ...
 *		},
 *	}
 */function ScrollView({option}){const{videoImageCount,imgUrl,startNum,extension,viewPort,viewItem,scrollAreaY}=option;const observerRef=(0,react_1.useRef)(null);const[ratio,setRatio]=(0,react_1.useState)(0);const imgNum=videoImageCount<=Math.round(ratio*videoImageCount/100)?videoImageCount:Math.round(ratio*videoImageCount/100);const imgScr=`${imgUrl}${startNum+imgNum}${extension}`;(0,react_1.useEffect)(()=>{const option={root:null,rootMargin:`${scrollAreaY} 0px 0px 0px`,threshold:(0,percentageArray_1.default)()};const observer=new IntersectionObserver(entries=>{entries.forEach(entry=>{if(ratio===100)return;if(entry.isIntersecting){setRatio(Math.round(entry.intersectionRatio*100));}});},option);if(observerRef.current)observer.observe(observerRef.current);// eslint-disable-next-line react-hooks/exhaustive-deps
},[]);return(0,jsx_runtime_1.jsxs)("div",{children:[(0,jsx_runtime_1.jsxs)("div",Object.assign({style:{position:'sticky',height:'100%',top:'0px'}},{children:[(0,jsx_runtime_1.jsx)("img",{style:viewPort,src:imgScr,alt:'ScrollView'}),viewItem]})),(0,jsx_runtime_1.jsx)("div",{style:{height:scrollAreaY},ref:observerRef})]});}exports.default=ScrollView;